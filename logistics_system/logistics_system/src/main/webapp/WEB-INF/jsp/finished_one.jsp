...
<div style="width:120px; height:23px; background-color:#00C">
...
<table border="0" cellspacing="0" cellpadding="0" style="width:100%" rules="rows">
    ...
    {
        if(confirm('查看'))
        window.location.href='ShowFinished/arrive?waybill_id='+waybill_id;
        else
         window.location.href='ShowFinished/showlist';
    }
        function back()
    {
        window.location.href='ShowFinished/showlist';
