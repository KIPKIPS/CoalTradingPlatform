  ...
  <body>
	...
	<table id="tblMain" class="table table-hover table-bordered">
	 ...
	 <tr><th colspan=6>已发布</th></tr>
    		...
    		<tbody>
    	<c:forEach var="listing" items="${sellerPublishList}">
    		<tr>
	 ...
	 <script>
 	   ...
 	   location.href="SellerGoodInfo/page?pageNum="+pageNum+"&maxPage="+${pageInfo.pages}+"&uID="+uID+"&flag=1";
 	   } 
 	   function next(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum+1}+"&maxPage="+${pageInfo.pages}+"&flag="+1+"&uID="+${sessionScope.trader.uID};
 	   }
 	   function back(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum-1}+"&maxPage="+${pageInfo.pages}+"&flag="+1+"&uID="+${sessionScope.trader.uID};
 	   }
