...
<html>
  ...
  <body>
	...
	<table id="tblMain" class="table table-hover table-bordered">
	 ...
	 <tr><th colspan=6>已下架</th></tr>
    		...
    		<tbody>
    	<c:forEach var="listing" items="${sellerUnderList}">
    		<tr>
 ...
 <script>
 	   ...
 	   location.href="SellerGoodInfo/page?pageNum="+pageNum+"&maxPage="+${pageInfo.pages}+"&uID="+uID+"&flag=2";
 	   }
 	   function next(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum+1}+"&maxPage="+${pageInfo.pages}+"&flag="+2+"&uID="+${sessionScope.trader.uID};
 	   }
 	   function back(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum-1}+"&maxPage="+${pageInfo.pages}+"&flag="+2+"&uID="+${sessionScope.trader.uID};
 	   }
