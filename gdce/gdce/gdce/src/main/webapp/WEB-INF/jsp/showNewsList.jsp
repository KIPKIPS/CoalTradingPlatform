		...
		$.ajax({
			...
			success : function(msg) {
				...
				jQuery.each(JSON.parse(newsList), function(i, item) {
					...
					$("#newsList").append("<div id = 'divnewsList" + i + "' class = 'newsListColor" + rand + "'><a href='News/getCheckedNewsById?nID=" + item.nID + "'><p><span class='span1'>" + (i + 1) + "</span><span class='span3'>" + item.nTheme + "</span><span class='span4'>" + item.nTime + "</span></p></a></div>")
