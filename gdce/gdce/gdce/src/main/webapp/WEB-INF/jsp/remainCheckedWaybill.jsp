...
<script>
    ...
    var pageSum = 0;
 	...
 	function getInfo2(){
		...
		$.ajax({
		type:"post",
   		url:"http://10.61.88.30:8082/logistics_system/waybill/getState0InfoByList",
   		dataType: "json", 
		...
		if(data!=null)
   			{
   				...
   				$("#tablePage").append("<tr><th>"+data[i].trade_id+"</th><th>"+data[i].waybill_id+"</th><th>"+data[i].log_weight+"</th><th>"+data[i].good_source+"</th><<th>"+data[i].good_destination+"</th><th>待发货</th></tr>");
