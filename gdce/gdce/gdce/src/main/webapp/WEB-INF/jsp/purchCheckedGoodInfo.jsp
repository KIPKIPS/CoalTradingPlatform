...
<html>
  ...
  <body>
	<table id="tblMain" class="table table-hover table-bordered">
	 ...
	 <tr><th colspan=11>待审核</th></tr>
    	...
    	<c:forEach var="listing" items="${purchCheckList}">
    		<tr>
 ...
 <script>
 	   ...
 	   if(pageNum)
 	   location.href="SellerGoodInfo/page?pageNum="+pageNum+"&maxPage="+${pageInfo.pages}+"&uID="+uID+"&flag=3";
 	   }
 	   function next(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum+1}+"&maxPage="+${pageInfo.pages}+"&flag="+3+"&uID="+${sessionScope.trader.uID};
 	   }
 	   function back(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum-1}+"&maxPage="+${pageInfo.pages}+"&flag="+3+"&uID="+${sessionScope.trader.uID};
 	   }
