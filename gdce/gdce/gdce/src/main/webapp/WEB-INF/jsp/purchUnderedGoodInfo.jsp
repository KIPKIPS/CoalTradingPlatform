  ...
  <body>
	...
	<table id="tblMain" class="table table-hover table-bordered">
	 ...
	 <tr><th colspan=11>已下架</th></tr>
    		...
    		<tbody>
    	<c:forEach var="listing" items="${purchUnderList}">
    		<tr>
     ...
     <script>
 	   ...
 	   if(pageNum)
 	   location.href="SellerGoodInfo/page?pageNum="+pageNum+"&maxPage="+${pageInfo.pages}+"&uID="+uID+"&flag=4";
 	   }
 	   function next(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum+1}+"&maxPage="+${pageInfo.pages}+"&flag="+4+"&uID="+${sessionScope.trader.uID};
 	   }
 	   function back(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum-1}+"&maxPage="+${pageInfo.pages}+"&flag="+4+"&uID="+${sessionScope.trader.uID};
 	   }
