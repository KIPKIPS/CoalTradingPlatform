...
<html>
  ...
  <body>
	...
	<table id="tblMain" class="table table-hover table-bordered">
		<thead>
	 	<tr><th colspan=6>待审核</th></tr>
    		...
    		<tbody>
    	<c:forEach var="listing" items="${sellerCheckList}">
    		<tr>
	...
	<script>
 	   ...
 	   function next(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum+1}+"&maxPage="+${pageInfo.pages}+"&flag="+0+"&uID="+${sessionScope.trader.uID};
 	   }
 	   function back(){
 	   location.href="SellerGoodInfo/page?pageNum="+${pageInfo.pageNum-1}+"&maxPage="+${pageInfo.pages}+"&flag="+0+"&uID="+${sessionScope.trader.uID};
 	   }
